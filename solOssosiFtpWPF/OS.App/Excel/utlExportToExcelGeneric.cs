...
{
    /// <summary>
    /// Clase que genera un excel desde una T: List<T>
    /// </summary>
    /// <typeparam name="T">Object:Class</typeparam>
    /// <typeparam name="U">List<Object></typeparam>
    public class utlExportToExcelGeneric<T, U>
        where T : class
        where U : List<T>
    {
        public List<T> dataToPrint;
        // Excel object references.
        private interopExcel.Application _excelApp = null;
        private interopExcel.Workbooks _books = null;
        private interopExcel._Workbook _book = null;
        private interopExcel.Sheets _sheets = null;
        private interopExcel._Worksheet _sheet = null;
        private interopExcel.Range _range = null;
        private interopExcel.Font _font = null;
        ...
        private void CreateExcelRef()
        {
            ...
            _books = (interopExcel.Workbooks)_excelApp.Workbooks;
            _book = (interopExcel._Workbook)(_books.Add(_optionalValue));
            _sheets = (interopExcel.Sheets)_book.Worksheets;
            _sheet = (interopExcel._Worksheet)(_sheets.get_Item(1));
        }
        /// <summary>
